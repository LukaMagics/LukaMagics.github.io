...
<p align="center"><img src="/assets/images/flexgrid.png" width="90%" height="auto"></p>
...
- 위와 같이 <span style="color: red">빨간색</span> 박스인 contents class를 category class 옆으로 붙이려할 때 grid를 사용할 수 있다.
- 먼저 grid로 만들기 위해 contents class와 category class를 **부모 태그로 묶어줘야한다**.
